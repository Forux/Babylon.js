...
uniform bool historyIsEmpty; // 1 - history empty, 0 - history present
    ...
    if (historyIsEmpty) {
        ...
        vec4 historyColor = TEXTUREFUNC(historySampler, previousCoords, 0.0);
            ...
            if (previousCoords.x > 1.0 || previousCoords.x < 0.0) {
                ...
                outColor = vec4(previousCoords, 0.0, 1.0);
            }
            ...
            if (uvChange.x == 0.0 && uvChange.y == 0.0) {
                ...
                outColor = vec4(uvChange, 0.0, 1.0);
            }
            ...
            outColor = mix(historyColor, newColor, factor);
        #else
            #ifdef CLIP_TO_AABB
