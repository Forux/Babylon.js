 ...
 */
export class TAARenderingPipelineAdvanced extends PostProcessRenderPipeline {
    /**
    ...
    /**
     * Get the class name
     * @returns "TAARenderingPipelineAdvanced"
     */
    public override getClassName(): string {
        return "TAARenderingPipelineAdvanced";
    }
    ...
    public serialize(): any {
        ...
        serializationObject.customType = "TAARenderingPipelineAdvanced";
     ...
     */
    public static Parse(source: any, scene: Scene, rootUrl: string): TAARenderingPipelineAdvanced {
        return SerializationHelper.Parse(() => new TAARenderingPipelineAdvanced(source._name, scene, source._ratio), source, scene, rootUrl);
    }
}

RegisterClass("BABYLON.TAARenderingPipelineAdvanced", TAARenderingPipelineAdvanced);