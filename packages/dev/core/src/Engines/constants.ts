...
export class Constants {
    ...
    //> VRNET
    /** Compressed BC6-7 */
    public static readonly TEXTUREFORMAT_COMPRESSED_RGBA_BPTC_UNORM_EXT = 36492;
    public static readonly TEXTUREFORMAT_COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT = 36493;
    public static readonly TEXTUREFORMAT_COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT = 36494;
    public static readonly TEXTUREFORMAT_COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT = 36495;
    /** Compressed ASTC */
